...
CC = g++
CFLAGS = -Wno-multichar -fno-rtti -D__STDC_CONSTANT_MACROS -D_FILE_OFFSET_BITS=64 -I../sdk/include -I../ffmpeg/include -I../tinyxml

CPPFLAGS = -D__STDC_CONSTANT_MACROS -D_FILE_OFFSET_BITS=64 -I../ffmpeg/include 

LFLAGS = -lrt -lbz2 -lz -lm -ldl -lpthread -L/usr/local/lib -L../tinyxml -ltinyxml -L../ffmpeg/lib -lavfilter -lswscale -lavformat -lavcodec -lavutil -lswresample -lcurl -luuid
...
GROUP.01.SRC = main.cpp \
			   ...
			   comms.cpp \
			   ftpupload.cpp \
			   ../sdk/include/DeckLinkAPIDispatch.cpp
